...
<!-- # `r icon::fa("hand-pointer", size=1, color="#fc9272")` dplyr::select() -->
...
<!-- # `r icon::fa("filter", size=1, color="#fc9272")` dplyr::filter() -->
...
<!--  No lógico: `r icon::fa("exclamation")` -->
<!-- ```{r eval=FALSE} -->
...
<!-- # `r icon::fa("sort", size=1, color="#fc9272")` dplyr::arrange() -->
...
<!-- # `r icon::fa("calculator", size=1, color="#fc9272")` dplyr::top_n() -->
...
<!-- # `r icon::fa("calculator", size=1, color="#fc9272")` dplyr::summarise() -->
...
<!-- # `r icon::fa("table", size=1, color="#fc9272")` dplyr::count() -->
...
<!-- # `r icon::fa("user-friends", size=1, color="#fc9272")`  dplyr::group_by() -->
